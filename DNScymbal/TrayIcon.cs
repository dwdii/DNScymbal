...
namespace DNScymbal
{
    class TrayIcon : Form
    {
        ...
        private void Init()
        {
            ...
            _contextMenu.MenuItems.Add(new MenuItem("Properties", new System.EventHandler(Properties_Click)));
            _contextMenu.MenuItems.Add(new MenuItem("Exit", new System.EventHandler(Exit_Click)));
